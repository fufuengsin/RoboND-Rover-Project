...
class RoverState():
    def __init__(self):
        ...
        self.see_rock_error = 0 # A commulative frame counter that rover mistakenly see the sample
        self.stuck_time = 0 # A commulative frame counter that rover get stuck
        self.error_limit = 120 # Threshhold of frames number that the rover get stuck
                               # or mistakenly enter 'goto_rock' mode
...
def telemetry(sid, data):
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            # but update perception only when the rover's vision is valid(rover is flat to the ground)
